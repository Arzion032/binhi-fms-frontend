      ...
      <div className="flex flex-1">
        ...
        <div className="flex flex-col justify-center items-center flex-1 p-12 space-y-6">
          <div className="bg-white rounded-3xl shadow-lg p-8 w-full max-w-md">
            ...
            <label htmlFor="contactInput" className="block text-gray-900 font-semibold mb-1">
              Phone Number/Email
            </label>
            <input
              id="contactInput"
              ...
              className={`w-full border rounded-full px-4 py-3 placeholder-gray-400 focus:outline-none focus:border-green-600 mb-2 ${
                validationError ? 'border-red-500 text-red' : 'border-gray-400 text-gray-400'
              }`}
            />
            {validationError && (
              <p className="text-red text-sm mb-4">{validationError}</p>
            )}
            ...
            <p className="text-center text-gray-700 text-sm">
              By continuing, you agree to BINHI <strong>Terms of Service</strong> and <strong>Privacy Policy</strong>.
            </p>
          </div>
          ...
          <div className="w-full max-w-md bg-white rounded-full shadow-md px-6 py-3 flex items-center gap-4">
            ...
            <button aria-label="Info" className="ml-auto text-gray-400 hover:text-gray-600">
              <svg
                className="w-5 h-5"
                fill="none"
                stroke="currentColor"
