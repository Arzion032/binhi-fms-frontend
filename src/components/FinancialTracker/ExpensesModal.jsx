...
const ExpensesModal = ({ isOpen, onClose }) => {
        ...
        <div className="bg-white rounded-3xl p-8 w-full max-w-md mx-4 shadow-lg relative">
          ...
          <div className="flex flex-col items-center">
            ...
            <p className="text-center text-gray-600 mb-8">
              ...
              The expense details will be lost.
            </p>
      ...
      <div className="fixed inset-0 bg-black bg-opacity-30 flex items-center justify-center z-50">
        <div className="bg-white rounded-3xl p-8 w-full max-w-md mx-4 shadow-lg relative">
          ...
          <div className="flex flex-col items-center">
            ...
            <h2 className="text-2xl font-bold mb-2">Expense recorded successfully!</h2>
            <p className="text-center text-gray-600 mb-8">Everything's set. Feel free to check your expenses!</p>
            <div className="flex gap-4">
              <button
                onClick={handleDone}
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-30 flex items-center justify-center z-50">
      <div className="bg-white rounded-2xl p-6 w-full max-w-md mx-4 border-[0.5px] border-gray-300 shadow-md">
        ...
        <p className="mb-4 text-sm text-gray-500">Please enter the expense.</p>
        ...
        <div className="mb-4">
          ...
          <div className="relative">
            ...
            >
              ...
              <option value="marketplace">Placeholder</option>
            </select>
